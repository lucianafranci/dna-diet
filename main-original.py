...
print('---------------------------------------------------------------------------')
print(
    f'[PROCESO N° 6] + GC Content ins subsection k=5: {gc_content_subsec(DNAStr, k=5)}\n')


print('---------------------------------------------------------------------------')
print(
    f'[PROCESO N° 7] + Aminoacids Sequence from DNA: {translate_seq(DNAStr, 0)}\n')


print('---------------------------------------------------------------------------')
print(f'[PROCESO N° 8] + Codon frequency (L):{codon_usage(DNAStr,"L")}')


print('---------------------------------------------------------------------------')
print('[PROCESO N° 9] + Reading frames:')
...
print('---------------------------------------------------------------------------')
print('[PROCESO N° 10] + Amino names:')
#test_protein_frame = ['MTALVVLVRRGS', 'MTALVVLVRRGS']

print(f'Ami from amino: {name_from_amino(test_rf_frame)}')
